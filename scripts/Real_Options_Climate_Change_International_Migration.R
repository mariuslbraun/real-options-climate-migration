...
df_total = read.csv("C:\\Users\\Marius Braun\\Documents\\A Real-Options Analysis of Climate Change and International Migration\\Revise and resubmit\\Dataset_final_v14_non_OECD.csv")
df_total$mig_rate_new = df_total$mig_rate * 100
# df_total$log_mig_rate = log(df_total$mig_rate_new)
# newdf = df[which(df$mig_rate_new < 10), ]
...
mig_rate_midinc_contig = df_midinc %>% filter(contiguity == 1) %>% dplyr::select(mig_rate_new)
mean(mig_rate_midinc_contig$mig_rate_new)
sd(mig_rate_midinc_contig$mig_rate_new)

mig_rate_lowinc_contig = df_lowinc %>% filter(contiguity == 1) %>% dplyr::select(mig_rate_new)
...
mig_rate_midinc_noncontig = df_midinc %>% filter(contiguity == 0) %>% dplyr::select(mig_rate_new)
mean(mig_rate_midinc_noncontig$mig_rate_new)
sd(mig_rate_midinc_noncontig$mig_rate_new)

mig_rate_lowinc_noncontig = df_lowinc %>% filter(contiguity == 0) %>% dplyr::select(mig_rate_new)
mean(mig_rate_lowinc_noncontig$mig_rate_new)
sd(mig_rate_lowinc_noncontig$mig_rate_new)

# migration rates to OECD countries
mig_rate_midinc_OECD_dest = df_midinc %>% filter(OECD_dest == 1) %>% dplyr::select(mig_rate_new)
mean(mig_rate_midinc_OECD_dest$mig_rate_new)
sd(mig_rate_midinc_OECD_dest$mig_rate_new)

mig_rate_lowinc_OECD_dest = df_lowinc %>% filter(OECD_dest == 1) %>% dplyr::select(mig_rate_new)
...
mig_rate_midinc_nonOECD_dest = df_midinc %>% filter(OECD_dest == 0) %>% dplyr::select(mig_rate_new)
mean(mig_rate_midinc_nonOECD_dest$mig_rate_new)
sd(mig_rate_midinc_nonOECD_dest$mig_rate_new)

mig_rate_lowinc_nonOECD_dest = df_lowinc %>% filter(OECD_dest == 0) %>% dplyr::select(mig_rate_new)
...
remove(ttest.mig_rate_new, ttest.temp_anom, ttest.precip_anom, ttest.share_temp_greater_1SD, ttest.share_precip_less_1SD, ttest.gdp_per_capita)
...
gc()
tic()
gam_total = mgcv::gam(df_total$mig_rate_new ~ s(df_total$temp_anom, bs='cr') + s(df_total$precip_anom, bs='cr') + df_total$period + df_total$X...origin + df_total$destination, family = Gamma(link="log"), data = df_total, method = "REML")
toc()
summary(gam_total)
...
g_total = mgcv::gam(df_total$mig_rate_new ~ df_total$temp_anom + df_total$precip_anom + df_total$period + df_total$X...origin + df_total$destination, family = Gamma(link="log"), data = df_total, method = "REML")
...
gc()
tic()
gam_lowinc = mgcv::gam(df_lowinc$mig_rate_new ~ s(df_lowinc$temp_anom, bs='cr') + s(df_lowinc$precip_anom, bs='cr') + df_lowinc$period + df_lowinc$X...origin + df_lowinc$destination, family = Gamma(link="log"), data = df_lowinc, method = "REML")
toc()
summary(gam_lowinc)
...
# linear model for comparison
g_lowinc = mgcv::gam(df_lowinc$mig_rate_new ~ df_lowinc$temp_anom + df_lowinc$precip_anom + df_lowinc$period + df_lowinc$X...origin + df_lowinc$destination, family = Gamma(link="log"), data = df_lowinc, method = "REML")
# Chi square test compared semiparametric and linear models
...
gc()
tic()
gam_midinc = mgcv::gam(df_midinc$mig_rate_new ~ s(df_midinc$temp_anom, bs='cr') + s(df_midinc$precip_anom, bs='cr') + df_midinc$period + df_midinc$X...origin + df_midinc$destination, family = Gamma(link="log"), data = df_midinc, method = "REML")
toc()
summary(gam_midinc)
...
# linear model for comparison
g_midinc = mgcv::gam(df_midinc$mig_rate_new ~ df_midinc$temp_anom + df_midinc$precip_anom + df_midinc$period + df_midinc$X...origin + df_midinc$destination, family = Gamma(link="log"), data = df_midinc, method = "REML")
...
gc()
tic()
# gam_lowinc_contig = mgcv::gam(df_lowinc$mig_rate_new ~ s(df_lowinc$temp_anom, bs='cr') + s(df_lowinc$temp_anom_contig, bs='cr') + s(df_lowinc$precip_anom, bs='cr') + s(df_lowinc$precip_anom_contig, bs='cr') + df_lowinc$period + df_lowinc$origin + df_lowinc$destination, family = Gamma(link = log), data = df_lowinc, method = "REML")
gam_lowinc_contig = mgcv::gam(df_lowinc$mig_rate_new ~ df_lowinc$contiguity + s(df_lowinc$temp_anom, bs='cr')  + s(df_lowinc$temp_anom, by = df_lowinc$contiguity, bs='cr') + s(df_lowinc$precip_anom, bs='cr') + s(df_lowinc$precip_anom, by = df_lowinc$contiguity, bs='cr') + df_lowinc$period + df_lowinc$X...origin + df_lowinc$destination, family = Gamma(link = "log"), data = df_lowinc, method = "REML")
toc()
...
plot(gam_lowinc_contig, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_lowinc_contig, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
...
gc()
tic()
gam_midinc_contig = mgcv::gam(df_midinc$mig_rate_new ~ df_midinc$contiguity + s(df_midinc$temp_anom, bs='cr')  + s(df_midinc$temp_anom, by = df_midinc$contiguity, bs='cr') + s(df_midinc$precip_anom, bs='cr') + s(df_midinc$precip_anom, by = df_midinc$contiguity, bs='cr') + df_midinc$period + df_midinc$X...origin + df_midinc$destination, family = Gamma(link="log"), data = df_midinc, method = "REML")
toc()
...
plot(gam_midinc_contig, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_midinc_contig, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
...
gc()
tic()
gam_lowinc_OECD = mgcv::gam(df_lowinc$mig_rate_new ~ df_lowinc$OECD_dest + s(df_lowinc$temp_anom, bs='cr') + s(df_lowinc$temp_anom, by = df_lowinc$OECD_dest, bs='cr') + s(df_lowinc$precip_anom, bs='cr') + s(df_lowinc$precip_anom, by = df_lowinc$OECD_dest, bs='cr') + df_lowinc$period + df_lowinc$X...origin + df_lowinc$destination, family = Gamma(link = "log"), data = df_lowinc, method = "REML")
toc()
...
gc()
tic()
gam_midinc_OECD = mgcv::gam(df_midinc$mig_rate_new ~ df_midinc$OECD_dest + s(df_midinc$temp_anom, bs='cr') + s(df_midinc$temp_anom, by = df_midinc$OECD_dest, bs='cr') + s(df_midinc$precip_anom, bs='cr') + s(df_midinc$precip_anom, by = df_midinc$OECD_dest, bs='cr') + df_midinc$period + df_midinc$X...origin + df_midinc$destination, family = Gamma(link = "log"), data = df_midinc, method = "REML")
toc()
...
gc()
tic()
gam_lowinc0.2 = mgcv::gam(df_lowinc0.2$mig_rate_new ~ s(df_lowinc0.2$temp_anom, bs='cr') + s(df_lowinc0.2$precip_anom, bs='cr') + df_lowinc0.2$period + df_lowinc0.2$X...origin + df_lowinc0.2$destination, family = Gamma(link = "log"), data = df_lowinc0.2, method = "REML")
toc()
...
plot(gam_lowinc0.2, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_lowinc0.2, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
...
gc()
tic()
gam_midinc0.2 = mgcv::gam(df_midinc0.2$mig_rate_new ~ s(df_midinc0.2$temp_anom, bs='cr') + s(df_midinc0.2$precip_anom, bs='cr') + df_midinc0.2$period + df_midinc0.2$X...origin + df_midinc0.2$destination, family = Gamma(link = "log"), data = df_midinc0.2, method = "REML")
toc()
...
plot(gam_midinc0.2, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_midinc0.2, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
...
gc()
tic()
gam_lowinc0.3 = mgcv::gam(df_lowinc0.3$mig_rate_new ~ s(df_lowinc0.3$temp_anom, bs='cr') + s(df_lowinc0.3$precip_anom, bs='cr') + df_lowinc0.3$period + df_lowinc0.3$X...origin + df_lowinc0.3$destination, family = Gamma(link = "log"), data = df_lowinc0.3, method = "REML")
toc()
...
plot(gam_lowinc0.3, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_lowinc0.3, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
...
gc()
tic()
gam_midinc0.3 = mgcv::gam(df_midinc0.3$mig_rate_new ~ s(df_midinc0.3$temp_anom, bs='cr') + s(df_midinc0.3$precip_anom, bs='cr') + df_midinc0.3$period + df_midinc0.3$X...origin + df_midinc0.3$destination, family = Gamma(link = "log"), data = df_midinc0.3, method = "REML")
toc()
...
plot(gam_midinc0.3, shade = TRUE, xlab = "Temperature anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
plot(gam_midinc0.3, shade = TRUE, xlab = "Precipitation anomalies", ylab = "", cex.lab = 1.4, cex.axis = 1.3)
title(ylab = "log of bilateral migration rates", mgp=c(2.5,1,0), cex.lab = 1.4)
abline(h=0, v=0, lty=2)
